...
public abstract class QueryStore {
     ...
     * @return Prepared UpdateQuery2 string
     */
    public String getUpdate2Graph(LdbcUpdate2AddPostLike operation) {
        return prepare(
                QueryType.InteractiveUpdate2Graph, getUpdate2GraphMap(operation)
        );
    }
     ...
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getUpdate2GraphMap(LdbcUpdate2AddPostLike operation) {
        return ImmutableMap.of(
            LdbcUpdate2AddPostLike.PERSON_ID, getConverter().convertId(operation.getPersonId()),
            LdbcUpdate2AddPostLike.POST_ID, getConverter().convertId(operation.getPostId()),
            LdbcUpdate2AddPostLike.CREATION_DATE, getConverter().convertDateTime(operation.getCreationDate())
     ...
     * @return Prepared UpdateQuery3 string
     */
    public String getUpdate3Graph(LdbcUpdate3AddCommentLike operation) {
        return prepare(
                QueryType.InteractiveUpdate3Graph, getUpdate3GraphMap(operation)
        );
    }
     ...
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getUpdate3GraphMap(LdbcUpdate3AddCommentLike operation) {
        return ImmutableMap.of(
            LdbcUpdate3AddCommentLike.PERSON_ID, getConverter().convertId(operation.getPersonId()),
            LdbcUpdate3AddCommentLike.COMMENT_ID, getConverter().convertId(operation.getCommentId()),
            LdbcUpdate3AddCommentLike.CREATION_DATE, getConverter().convertDateTime(operation.getCreationDate())
     ...
     * @return Prepared UpdateQuery5 string
     */
    public String getUpdate5Graph(LdbcUpdate5AddForumMembership operation) {
        return prepare(
                QueryType.InteractiveUpdate5Graph, getUpdate5GraphMap(operation)
        );
    }
     ...
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getUpdate5GraphMap(LdbcUpdate5AddForumMembership operation) {
        return ImmutableMap.of(
            LdbcUpdate5AddForumMembership.FORUM_ID, getConverter().convertId(operation.getForumId()),
            LdbcUpdate5AddForumMembership.PERSON_ID, getConverter().convertId(operation.getPersonId()),
            LdbcUpdate5AddForumMembership.JOIN_DATE, getConverter().convertDateTime(operation.getJoinDate())
     ...
     * @return Prepared UpdateQuery8 string
     */
    public String getUpdate8Graph(LdbcUpdate8AddFriendship operation) {
        return prepare(
                QueryType.InteractiveUpdate8Graph, getUpdate8GraphMap(operation)
        );
    }
     ...
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getUpdate8GraphMap(LdbcUpdate8AddFriendship operation) {
        return ImmutableMap.of(
            LdbcUpdate8AddFriendship.PERSON1_ID, getConverter().convertId(operation.getPerson1Id()),
            LdbcUpdate8AddFriendship.PERSON2_ID, getConverter().convertId(operation.getPerson2Id()),
            LdbcUpdate8AddFriendship.CREATION_DATE, getConverter().convertDateTime(operation.getCreationDate())
    ...
    /**
     * Get prepared Micro1 string
     * @param operation LdbcMicro1 operation containing parameter values
     * @return Prepared Micro1 string
     */
    public String getMicro1(LdbcShortQuery4MessageContent operation) {
        return prepare(
                QueryType.Micro1, getMicro1Map(operation)
        );
    }
    
    /**
     * Get Micro1 Map. This map contain the name of the parameter and the value as string.
     * @param operation Micro1 operation containing parameter values
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getMicro1Map(LdbcShortQuery4MessageContent operation) {
        return ImmutableMap.of(LdbcShortQuery4MessageContent.MESSAGE_ID, getConverter().convertId(operation.getMessageIdContent()));
    }

    /**
     * Get prepared Micro2 string
     * @param operation LdbcMicro2 operation containing parameter values
     * @return Prepared Micro2 string
     */
    public String getMicro2(LdbcShortQuery1PersonProfile operation) {
        return prepare(
                QueryType.Micro2, getMicro2Map(operation)
        );
    }

    /**
     * Get getMicro2 Map. This map contain the name of the parameter and the value as string.
     * @param operation LdbcMicro2 operation containing parameter values
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getMicro2Map(LdbcShortQuery1PersonProfile operation) {
        return ImmutableMap.of(LdbcShortQuery1PersonProfile.PERSON_ID, getConverter().convertId(operation.getPersonIdSQ1()));
    }

    /**
     * Get prepared Micro3 string
     * @param operation LdbcMicro3 operation containing parameter values
     * @return Prepared Micro3 string
     */
    public String getMicro3(LdbcShortQuery5MessageCreator operation) {
        return prepare(
                QueryType.Micro3, getMicro3Map(operation)
        );
    }

    /**
     * Get Micro3 Map. This map contain the name of the parameter and the value as string.
     * @param operation Micro3 operation containing parameter values
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getMicro3Map(LdbcShortQuery5MessageCreator operation) {
        return ImmutableMap.of(LdbcShortQuery5MessageCreator.MESSAGE_ID, getConverter().convertId(operation.getMessageIdCreator()));
    }

    
    /**
     * Get prepared Micro4 string
     * @param operation LdbcMicro4 operation containing parameter values
     * @return Prepared Micro4 string
     */
    public String getMicro4(LdbcShortQuery3PersonFriends operation) {
        return prepare(
                QueryType.Micro4, getMicro4Map(operation)
        );
    }

    /**
     * Get Micro4 Map. This map contain the name of the parameter and the value as string.
     * @param operation LdbcMicro4 operation containing parameter values
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getMicro4Map(LdbcShortQuery3PersonFriends operation) {
        return ImmutableMap.of(LdbcShortQuery3PersonFriends.PERSON_ID, getConverter().convertId(operation.getPersonIdSQ3()));
    }
    ...
    /**
     * Get prepared Recommendation1 string
     * @param operation LdbcRecommendation1 operation containing parameter values
     * @return Prepared Recommendation1 string
     */
    public String getRecommendation1(LdbcQuery2 operation) {
        return prepare(
                QueryType.Recommendation1, getRecommendation1Map(operation)
        );
    }

    /**
     * Get Recommendation1 Map. This map contain the name of the parameter and the value as string.
     * @param operation LdbcRecommendation1 operation containing parameter values
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getRecommendation1Map(LdbcQuery2 operation) {
        return new ImmutableMap.Builder<String, Object>()
        .put(LdbcQuery2.PERSON_ID, getConverter().convertId(operation.getPersonIdQ2()))
        .put(LdbcQuery2.MAX_DATE, getConverter().convertDate(operation.getMaxDate()))
        .build();
    ...
    /**
     * Get prepared Recommendation2 string
     * @param operation LdbcRecommendation2 operation containing parameter values
     * @return Prepared Recommendation2 string
     */
    public String getRecommendation2(LdbcQuery4 operation) {
        return prepare(
                QueryType.Recommendation2, getRecommendation2Map(operation)
        );
    }

    /**
     * Get Recommendation2 Map. This map contain the name of the parameter and the value as string.
     * @param operation LdbcRecommendation2 operation containing parameter values
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getRecommendation2Map(LdbcQuery4 operation) {
        return new ImmutableMap.Builder<String, Object>()
        .put(LdbcQuery4.PERSON_ID, getConverter().convertId(operation.getPersonIdQ4()))
        .put(LdbcQuery4.START_DATE, getConverter().convertDate(operation.getStartDate()))
        .put(LdbcQuery4.DURATION_DAYS, getConverter().convertInteger(operation.getDurationDays()))
    ...
    /**
     * Get prepared Fraud1 string
     * @param operation LdbcFraud1 operation containing parameter values
     * @return Prepared Fraud1 string
     */
    public String getFraud1(LdbcQuery2 operation) {
        return prepare(
                QueryType.Fraud1, getFraud1Map(operation)
        );
    }

    /**
     * Get Fraud1 Map. This map contain the name of the parameter and the value as string.
     * @param operation LdbcFraud1 operation containing parameter values
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getFraud1Map(LdbcQuery2 operation) {
        return new ImmutableMap.Builder<String, Object>()
        .put(LdbcQuery2.PERSON_ID, getConverter().convertId(operation.getPersonIdQ2()))
        .put(LdbcQuery2.MAX_DATE, getConverter().convertDate(operation.getMaxDate()))
        .build();
    ...
    /**
     * Get prepared Fraud2 string
     * @param operation LdbcFraud2 operation containing parameter values
     * @return Prepared Fraud2 string
     */
    public String getFraud2(LdbcQuery4 operation) {
        return prepare(
                QueryType.Fraud2, getFraud2Map(operation)
        );
    }

    /**
     * Get Fraud2 Map. This map contain the name of the parameter and the value as string.
     * @param operation LdbcFraud2 operation containing parameter values
     * @return Map with parameters and values as string.
     */
    public Map<String, Object> getFraud2Map(LdbcQuery4 operation) {
        return new ImmutableMap.Builder<String, Object>()
        .put(LdbcQuery4.PERSON_ID, getConverter().convertId(operation.getPersonIdQ4()))
        .put(LdbcQuery4.START_DATE, getConverter().convertDate(operation.getStartDate()))
        .put(LdbcQuery4.DURATION_DAYS, getConverter().convertInteger(operation.getDurationDays()))
